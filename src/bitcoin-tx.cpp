...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s moecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  moecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded moecoin transaction") + "\n" +
              "  moecoin-tx [options] -create [commands]   " + _("Create hex-encoded moecoin transaction") + "\n" +
              "\n";
